// Line icons — single source. <Icon name="..." />
const ICON_PATHS = {
  ...
  collapse: '<rect x="3" y="4" width="18" height="16" rx="3"/><path d="M9 4v16"/><path d="m15 9-2 3 2 3"/>',
...
function Icon({ name, size = 20, className = '', stroke = 2 }) {
