...
class DeepSeekConfig:
    ...
    TOKENS = {
        'analyze_project': 4000,      # анализ проекта (для 9 функций + JSON)
        'create_plan': 3500,          # план действий
        'generate_checklist': 3000,   # чек-лист
        'consolidate': 4500,          # консолидация результатов всех агентов
    }
