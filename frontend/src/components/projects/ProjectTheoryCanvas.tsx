...
const stakeholderTypeOptionsByRole: Record<string, string[]> = {
  ...
  'Сообщество / общее благо': ['Социальный'],
...
const constraintTypeOptions = [
  ...
  'Содержание / границы проекта',
  'Стратегический выбор / компромисс',
...
const constraintSubtypeOptionsByType: Record<string, string[]> = {
  ...
  'Содержание / границы проекта': ['что входит в проект', 'что не входит в проект', 'география', 'клиентский сегмент', 'функция / процесс', 'продукт / услуга', 'организационная единица'],
  'Стратегический выбор / компромисс': ['где играем', 'где не играем', 'как выигрываем', 'каким способом не выигрываем', 'от чего отказываемся', 'какие действия не допускаются'],
  'Компетенции / способности': ['недостающая компетенция', 'требуемый уровень компетенции', 'ограничение по найму', 'ограничение по обучению', 'зависимость от партнера', 'ограничение по управленческому опыту'],
  ...
  'Юридическое / регуляторное': ['закон', 'договор', 'лицензия', 'регламент', 'требования безопасности', 'комплаенс'],
  'Социальное воздействие': ['вред клиентам', 'вред сотрудникам', 'вред обществу / общее благо', 'репутационный ущерб', 'негативное внешнее воздействие'],
...
const preserveElementTypeOptions = [
  ...
  'Предназначение / устойчивое предназначение',
  'Стандарты качества',
  ...
  'Информационный капитал',
  'Организационный капитал',
  'Социальная ответственность / общее благо',
...
const preserveCoreReasonOptions = [
  ...
  'Это требование общее благо / общественной пользы',
];
...
const preserveIndicatorOptionsByType: Record<string, string[]> = {
  'Ценности / базовые ценности': ['Соответствие ценностям / принципам', 'Уровень доверия / репутации'],
  'Предназначение / устойчивое предназначение': ['Соответствие ценностям / принципам', 'Отсутствие негативного социального воздействия'],
  'Стандарты качества': ['Уровень качества', 'Количество жалоб', 'Соблюдение SLA'],
  'Отношения с клиентами': ['Удовлетворенность клиента', 'Удержание / сохранение клиентов', 'Количество жалоб'],
  ...
  'Социальная ответственность / общее благо': ['Отсутствие негативного социального воздействия', 'Соответствие ценностям / принципам'],
