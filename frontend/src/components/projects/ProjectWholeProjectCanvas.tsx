    ...
    <div className="project-theory project-whole-project">
      <section className="project-theory-hero">
        <div>
          ...
          <h2>Весь проект</h2>
          <p>Логика Теории проекта: из Миссии вытекают её блоки — клиент, критерии результата, компетенции, ограничения, качество и сохраняемое ядро. Раскройте блок, чтобы увидеть элементы; наведите на элемент, чтобы подсветить смысловые связи. Остальные разделы подключим отдельно.</p>
        </div>
