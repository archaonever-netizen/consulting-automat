    ...
    <div className="project-theory project-whole-project">
      <section className="project-theory-hero">
        <div>
          ...
          <h2>Весь проект</h2>
          <p>Логика Теории проекта: из Миссии вытекают её блоки — клиент, критерии результата, компетенции, ограничения, качество и сохраняемое ядро. Раскройте блок, чтобы увидеть элементы. Наведите на узел — связи подсветятся временно; кликните — закрепятся (повторный клик снимает, клик по пустому полю — снимает все). Двойной клик открывает Теорию. Остальные разделы подключим отдельно.</p>
        </div>
